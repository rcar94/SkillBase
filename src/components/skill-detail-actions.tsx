...
import { SkillFileDialog } from "@/components/skill-file-dialog";
  ...
  return (
    <div className="mt-5 grid gap-3">
      <a
        ...
        href={downloadHref}
        onClick={() => setMessage("Downloaded SKILL.md.")}
      >
        Download skill
      </a>
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
        <SkillFileDialog filename={previewFilename} markdown={markdown} />
        <button
